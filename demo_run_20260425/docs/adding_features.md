...
Run with: `uv run demo_run_20260425 cmd my-command --name test`
...
# Or use CLI
uv run demo_run_20260425 db migrate -m "Add notifications table"
uv run demo_run_20260425 db upgrade
```
